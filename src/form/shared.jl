...
function variable_flow_directed(gm::GenericGasModel{T}, n::Int=gm.cnw; bounded::Bool = true) where T <: AbstractMIDirectedForms # TODO becomes AbstractMIForms
    variable_mass_flow(gm,n; bounded=bounded)
...
"Variables needed for modeling flow in MI models when some edges are directed"
function variable_flow_ne_directed(gm::GenericGasModel{T}, n::Int=gm.cnw; bounded::Bool = true) where T <: AbstractMIDirectedForms # TODO becomes AbstractMIForms
    variable_mass_flow_ne(gm,n; bounded=bounded)
