...
"LRWP Model Type"
mutable struct LRWPGasModel <: AbstractLRWPModel
    @gm_fields
end


"LRDWP Model Type"
mutable struct LRDWPGasModel <: AbstractLRDWPModel
    @gm_fields
end


"WP Model Type"
mutable struct WPGasModel <: AbstractWPModel
    @gm_fields
end


"CRDWP Model Type"
mutable struct CRDWPGasModel <: AbstractCRDWPModel
    @gm_fields
end


"DWP Model Type"
mutable struct DWPGasModel <: AbstractDWPModel
    @gm_fields
end
