...
function constraint_transfer_separation(
    ...
    con(gm, nw, :effective_transfer_withdrawal)[transfer_id] =
...
function constraint_compressor_physics(
    ...
    con(gm, nw, :compressor_physics_boost)[compressor_id] =
        JuMP.@constraint(gm.model, p_to == alpha * p_fr)
    con(gm, nw, :compressor_physics_flow)[compressor_id] =
...
function constraint_compressor_power(
    ...
    con(gm, nw, :compressor_power)[compressor_id] =
