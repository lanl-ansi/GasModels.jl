...
function build_solution(gm::AbstractGasModel, solve_time; objective=NaN, solution_builder=get_solution!)
...
""
function init_solution(gm::AbstractGasModel)
...
function get_solution!(gm::AbstractGasModel,sol::Dict{String,Any})
