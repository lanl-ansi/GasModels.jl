...
function constraint_pipe_parallel_flow(gm::AbstractMIModels, idx; n::Int = gm.cnw)
    ...
    opposite_valves,
    aligned_regulators,
    opposite_regulators = _calc_parallel_connections(gm, n, pipe)
...
function constraint_compressor_parallel_flow(gm::AbstractMIModels, idx; n::Int = gm.cnw)
    ...
    opposite_valves,
    aligned_regulators,
    opposite_regulators = _calc_parallel_connections(gm, n, compressor)
...
function constraint_resistor_parallel_flow(gm::AbstractMIModels, idx; n::Int = gm.cnw)
    ...
    opposite_valves,
    aligned_regulators,
    opposite_regulators = _calc_parallel_connections(gm, n, resistor)
...
function constraint_valve_parallel_flow(gm::AbstractMIModels, idx; n::Int = gm.cnw)
    ...
    opposite_valves,
    aligned_regulators,
    opposite_regulators = _calc_parallel_connections(gm, n, valve)
