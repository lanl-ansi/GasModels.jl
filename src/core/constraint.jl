...
" All constraints associated with flows through at a junction with variable production and consumption "
...
" All constraints associated with flows through at a junction with variable production and consumption and some directed edges"
constraint_junction_mass_flow_ls_directed(gm::GenericGasModel, i::Int) = constraint_junction_mass_flow_ls_directed(gm, gm.cnw, i)

" All constraints associated with flows through at a junction with expansion options and some directed edges"
constraint_junction_mass_flow_ne_directed(gm::GenericGasModel, i::Int) = constraint_junction_mass_flow_ne_directed(gm, gm.cnw, i)

" All constraints associated with flows through at a junction with expansion options, some directed edges, and variable production and consumption"
...
" All constraints associated with flows through a pipe that has flow in one direction"
...
" All constraints associated with flows through a compressor that has flow in one direction"
...
" All constraints associated with flows through a valve that has flow in one direction"
...
"Constraint: Constraints for computing mass flow balance at a node when some edges are directed"
function constraint_junction_mass_flow_directed(gm::GenericGasModel, n::Int, i)
    constraint_junction_mass_flow_balance(gm, n, i)
end

"Constraint: Constraints for computing mass flow balance at node when injections are variables and some edges are directed"
...
"Constraint: Constraints for computing mass flow balance at node when there are expansion edges and some edges are directed"
...
"Constraint: Constraints for computing mass flow balance at node when there are expansion edges, variable injections, and some edges are directed"
...
"Constraint: Constraints the define the pressure drop across a pipe when the pipe is directed"
