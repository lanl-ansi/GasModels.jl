@testset "test ls" begin
    ...
    @testset "test case 6 crdwp ls priority" begin
        @_info "Testing case 6 crdwp ls priority gaslib 40"
    ...
    @testset "test case 6 lrdwp ls" begin
        @_info "Testing case 6 lrdwp ls gaslib 40"
    ...
    @testset "test case 6 lrdwp ls priority" begin
        @_info "Testing case 6 lrdwp ls priority gaslib 40"
    ...
    @testset "test case 6 lrwp ls" begin
        @_info "Testing case 6 lrwp ls gaslib 40"
    ...
    @testset "test case 6 lrwp ls priority" begin
        @_info "Testing case 6 lrwp ls priority gaslib 40"
    ...
    @testset "test case 6 wp ls" begin
        @_info "Testing case 6 wp ls case"
    ...
    @testset "test case 6 wp priority" begin
        @_info "Testing case 6 ls priority case 6"
    ...
    @testset "test case 6 cwp ls" begin
        @_info "Testing case 6 cwp ls gaslib 40"
    ...
    @testset "test case 6 40 cwp priority" begin
        @_info "Testing case 6 cwp ls priority case 6"
