@testset "test gf" begin
    @testset "test crdwp gf" begin
        ...
        result = solve_gf("../test/data/gaslib/GasLib-Integration.zip", CRDWPGasModel, misocp_solver)
        @test result["termination_status"] in [LOCALLY_SOLVED, ALMOST_LOCALLY_SOLVED, OPTIMAL, :Suboptimal]
    end
    ...
    @testset "test wp gf" begin
        ...
        result = solve_gf("../test/data/gaslib/GasLib-Integration.zip", WPGasModel, minlp_solver)
        @test result["termination_status"] in [LOCALLY_SOLVED, ALMOST_LOCALLY_SOLVED, OPTIMAL, :Suboptimal]
    end
    ...
    @testset "test dwp gf" begin
        ...
        result = solve_gf("../test/data/gaslib/GasLib-Integration.zip", DWPGasModel, minlp_solver)
        @test result["termination_status"] in [LOCALLY_SOLVED, ALMOST_LOCALLY_SOLVED, OPTIMAL, :Suboptimal]
    end
end
