...
mgc.sound_speed = 299.0;
mgc.temperature = 259.0;
mgc.R = 8.0;
mgc.compressibility_factor = 0.6;
mgc.gas_molar_mass = 0.01;
mgc.gas_specific_gravity = 0.4;
...
mgc.compressor = [
1	1	5	0.5	2.5	100000000	0	1000    1
2	2	6	0.5	2.5	100000000	0	1000    1
];
