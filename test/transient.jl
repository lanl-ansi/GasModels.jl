@testset "transient parsing" begin
    ...
    @test length(mn_data["it"]["ng"]["nw"]) == 25
    @test isapprox(mn_data["it"]["ng"]["time_step"] * mn_data["it"]["ng"]["base_time"], 3600.0; atol = 1e-3)
...
@testset "transient (steady state replicate) case" begin
    ...
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["1"]["receipt"]["1"]["injection"], 94.80, atol = 1e-1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["receipt"]["1"]["injection"], 94.80, atol = 1e-1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["compressor"]["1"]["power_var"], 3e6, atol = 10)
end
...
@testset "transient time-periodic withdrawal case" begin
    ...
    make_si_units!(result["solution"])
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["1"]["receipt"]["1"]["injection"], 87.75, atol = 1e-1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["receipt"]["1"]["injection"], 93.27, atol = 1e-1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["compressor"]["1"]["power_var"], 3e6, atol = 10)
end
...
@testset "transient (steady state replicate) case with storage" begin
    ...
    @test result["termination_status"] == LOCALLY_SOLVED
    make_si_units!(result["solution"])
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["1"]["receipt"]["1"]["injection"], 44, atol = 1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["receipt"]["1"]["injection"], 44, atol = 1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["1"]["storage"]["1"]["withdrawal"], -86, atol = 1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["storage"]["1"]["withdrawal"], -86, atol = 1)
end
...
@testset "transient time-periodic withdrawal case with storage" begin
    ...
    make_si_units!(result["solution"])
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["1"]["receipt"]["1"]["injection"], 0, atol = 1e-1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["receipt"]["1"]["injection"], 0.0, atol = 1e-1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["1"]["storage"]["1"]["withdrawal"], -83, atol = 1)
    @test isapprox(result["solution"]["it"]["ng"]["nw"]["2"]["storage"]["1"]["withdrawal"], -83, atol = 1)
end
