@testset "test minlp ne gaslib 40" begin
    @testset "gaslib 40 5% case" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-5.m", MINLPGasModel, minlp_solver)
    ...
    @testset "gaslib 40 10% case" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-10.m", MINLPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 50% case" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-50.m", MINLPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 75% case" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-75.m", MINLPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 100% case" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-100.m", MINLPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 125% case" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-125.m", MINLPGasModel, minlp_solver)
    ...
    @testset "gaslib 40 150% case" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-150.m", MINLPGasModel, minlp_solver)
        @test result["termination_status"] == INFEASIBLE || result["termination_status"] == :LocalInfeasible
    end
end
...
@testset "test misocp ne gaslib 40" begin
    @testset "gaslib 40 case 5%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-5.m", MISOCPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 11.92; atol = 1e-2)
        GC.gc()
    end
    ...
    @testset "gaslib 40 case 10%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-10.m", MISOCPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 32.83; atol = 1e-2)
        GC.gc()
    end
    ...
    @testset "gaslib 40 case 25%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-25.m", MISOCPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 case 50%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-50.m", MISOCPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 156.06; atol = 1e-2)
        GC.gc()
    end
    ...
    @testset "gaslib 40 case 75%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-75.m", MISOCPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 333.01; atol = 1e-2)
        GC.gc()
    end
    ...
    @testset "gaslib 40 case 100%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-100.m", MISOCPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED || result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 551.64; atol = 1e-2)
        GC.gc()
    end
    ...
    @testset "gaslib 40 case 125%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-125.m", MISOCPGasModel, misocp_solver)
    ...
    @testset "gaslib 40 case 150%" begin
        ...
        result = run_ne("../examples/data/matgas/gaslib-40-150.m", MISOCPGasModel, misocp_solver)
        @test result["termination_status"] == INFEASIBLE || result["termination_status"] == INFEASIBLE_OR_UNBOUNDED
        GC.gc()
    end
end
