@testset "test wp ne gaslib 40" begin
    ...
    @testset "gaslib 40 150% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-150.m", WPGasModel, minlp_solver)
        @test result["termination_status"] == INFEASIBLE ||
              result["termination_status"] == :LocalInfeasible
    end
...
@testset "test dwp ne gaslib 40" begin
    @testset "gaslib 40 5% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-5.m", DWPGasModel, minlp_solver)
    ...
    @testset "gaslib 40 10% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-10.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 25% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-25.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 50% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-50.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 75% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-75.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 100% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-100.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 40 125% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-125.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == INFEASIBLE ||
              result["termination_status"] == :LocalInfeasible
    end
    ...
    @testset "gaslib 40 150% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-150.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == INFEASIBLE ||
              result["termination_status"] == :LocalInfeasible
    end
end
...
@testset "test crdwp ne gaslib 40" begin
    @testset "gaslib 40 case 5%" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-5.m", CRDWPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 11.92; atol = 1e-2)
        GC.gc()
    ...
    @testset "gaslib 40 case 10%" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-10.m", CRDWPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 32.83; atol = 1e-2)
        GC.gc()
    ...
    @testset "gaslib 40 case 25%" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-25.m", CRDWPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 41.08; atol = 1e-2)
        GC.gc()
    ...
    @testset "gaslib 40 case 50%" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-50.m", CRDWPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 156.06; atol = 1e-2)
        GC.gc()
    ...
    @testset "gaslib 40 case 75%" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-40-E-75.m", CRDWPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 333.01; atol = 1e-2)
        GC.gc()
    ...
    @testset "gaslib 40 case 100%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-40-E-100.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "gaslib 40 case 125%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-40-E-125.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == INFEASIBLE ||
    ...
    @testset "gaslib 40 case 150%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-40-E-150.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == INFEASIBLE ||
