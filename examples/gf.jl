@testset "test gf" begin
    ...
    @testset "test crdwp gf" begin
        @testset "gaslib 40 crdwp gf" begin
            ...
            result = run_gf(
                "../examples/data/matgas/gaslib-40-E.m",
                CRDWPGasModel,
                misocp_solver,
            )
        ...
        @testset "gaslib 582 case" begin
            ...
            result = run_gf(
                "../examples/data/matgas/gaslib-582-G.m",
                CRDWPGasModel,
                misocp_solver,
            )
            @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "test lrdwp gf" begin
        @testset "gaslib 40 lrdwp gf" begin
            ...
            result =
                run_gf("../examples/data/matgas/gaslib-40-E.m", LRDWPGasModel, mip_solver)
            @test result["termination_status"] == LOCALLY_SOLVED ||
                  result["termination_status"] == OPTIMAL
            @test isapprox(result["objective"], 0; atol = 1e-6)
        end
        ...
        @testset "gaslib 135 lrdwp gf" begin
            ...
            result =
                run_gf("../examples/data/matgas/gaslib-135-F.m", LRDWPGasModel, mip_solver)
            @test result["termination_status"] == LOCALLY_SOLVED ||
                  result["termination_status"] == OPTIMAL
            @test isapprox(result["objective"], 0; atol = 1e-6)
        end
    ...
    @testset "test lrwp gf" begin
        @testset "gaslib 40 lrwp gf" begin
            ...
            result =
                run_gf("../examples/data/matgas/gaslib-40-E.m", LRWPGasModel, lp_solver)
            @test result["termination_status"] == LOCALLY_SOLVED ||
                  result["termination_status"] == OPTIMAL ||
        ...
        @testset "gaslib 135 lrwp gf" begin
            ...
            result =
                run_gf("../examples/data/matgas/gaslib-135-F.m", LRWPGasModel, lp_solver)
            @test result["termination_status"] == LOCALLY_SOLVED ||
                  result["termination_status"] == OPTIMAL
            @test isapprox(result["objective"], 0; atol = 1e-6)
        end
    ...
    @testset "test dwp gf" begin
        @testset "gaslib 40 case" begin
            ...
            result =
                run_gf("../examples/data/matgas/gaslib-40-E.m", DWPGasModel, minlp_solver)
            @test result["termination_status"] == LOCALLY_SOLVED ||
                  result["termination_status"] == OPTIMAL
            @test isapprox(result["objective"], 0; atol = 1e-6)
        end
    ...
    @testset "test wp gf" begin
        ...
        @testset "gaslib 135 wp gf" begin
            ...
            result =
                run_gf("../examples/data/matgas/gaslib-135-F.m", WPGasModel, nlp_solver)
            @test result["termination_status"] == LOCALLY_SOLVED ||
                  result["termination_status"] == OPTIMAL ||
                  result["termination_status"] == ALMOST_LOCALLY_SOLVED
            @test isapprox(result["objective"], 0; atol = 1e-6)
