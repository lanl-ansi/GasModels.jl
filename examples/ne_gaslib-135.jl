@testset "test wp ne gaslib 135" begin
    ...
    @testset "gaslib 135 5% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-135-F-5.m", WPGasModel, minlp_solver;)
    ...
    @testset "gaslib 135 200% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-135-F-200.m", WPGasModel, minlp_solver)
...
@testset "test dwp ne gaslib 135" begin
    ...
    @testset "gaslib 135 25% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-135-F-25.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
    ...
    @testset "gaslib 135 125% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-135-F-125.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == INFEASIBLE ||
              result["termination_status"] == :LocalInfeasible
    end
    ...
    @testset "gaslib 135 150% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-135-F-150.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == INFEASIBLE ||
              result["termination_status"] == :LocalInfeasible
    end
    ...
    @testset "gaslib 135 200% case" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-135-F-200.m", DWPGasModel, minlp_solver)
        @test result["termination_status"] == INFEASIBLE ||
              result["termination_status"] == :LocalInfeasible
    end
end
...
@testset "test crdwp ne gaslib 135" begin
    ...
    @testset "gaslib 135 case 5%" begin
        ...
        result =
            run_ne("../examples/data/matgas/gaslib-135-F-5.m", CRDWPGasModel, misocp_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 0.0; atol = 1e-2)
        GC.gc()
    ...
    @testset "gaslib 135 case 10%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-10.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "gaslib 135 case 25%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-25.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "gaslib 135 case 50%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-50.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "gaslib 135 case 75%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-75.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "gaslib 135 case 100%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-100.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "gaslib 135 case 125%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-125.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == INFEASIBLE ||
    ...
    @testset "gaslib 135 case 150%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-150.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == INFEASIBLE ||
    ...
    @testset "gaslib 135 case 200%" begin
        ...
        result = run_ne(
            "../examples/data/matgas/gaslib-135-F-200.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == INFEASIBLE ||
