@testset "test ls" begin
    ...
    @testset "test gaslib 40 crdwp ls" begin
        @_info "Testing gaslib crdwp ls gaslib 40"
    ...
    @testset "test gaslib 40 crdwp ls priority" begin
        @_info "Testing gaslib crdwp ls priority gaslib 40"
    ...
    @testset "test gaslib 40 lrdwp ls" begin
        @_info "Testing gaslib lrdwp ls gaslib 40"
    ...
    @testset "test gaslib 40 lrdwp ls priority" begin
        @_info "Testing gaslib lrdwp ls priority gaslib 40"
    ...
    @testset "test gaslib 40 lrwp ls" begin
        @_info "Testing gaslib lrwp ls gaslib 40"
    ...
    @testset "test gaslib 40 lrwp ls priority" begin
        @_info "Testing gaslib lrwp ls priority gaslib 40"
    ...
    @testset "test gaslib 40 wp ls" begin
        @_info "Testing gaslib wp ls gaslib 40"
        ...
        @_warn(result["termination_status"])
    end
