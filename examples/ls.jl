@testset "test ls" begin
    ...
    @testset "test gaslib 40 crdwp ls" begin
        ...
        result =
            run_ls("../examples/data/matgas/gaslib-40-E-ls.m", CRDWPGasModel, misocp_solver)
    ...
    @testset "test gaslib 40 crdwp ls priority" begin
        ...
        result = run_ls(
            "../examples/data/matgas/gaslib-40-E-ls-priority.m",
            CRDWPGasModel,
            misocp_solver,
        )
        @test result["termination_status"] == LOCALLY_SOLVED ||
    ...
    @testset "test gaslib 40 lrdwp ls" begin
        ...
        result =
            run_ls("../examples/data/matgas/gaslib-40-E-ls.m", LRDWPGasModel, mip_solver)
        @test result["termination_status"] == LOCALLY_SOLVED ||
              result["termination_status"] == OPTIMAL ||
              result["termination_status"] == :Suboptimal
        @test isapprox(
